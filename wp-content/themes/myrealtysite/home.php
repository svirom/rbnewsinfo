...
<!--Home Page-->
		...
		<div class="row main_outer">	
			<div class="col-md-8 col-md-push-4 col-lg-9 col-lg-push-3 main_content">
	...
	<!-- -End Loop-->				
			...
			<div class="col-sm-4 col-md-4 col-md-pull-8 col-lg-3 col-lg-pull-9"><?php get_sidebar('left'); ?></div>
